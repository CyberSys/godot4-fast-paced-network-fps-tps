...
* [InterpolationController.cs](https://github.com/TeamStriked/godot4-fast-paced-network-fps-tps/blob/master/Example/Framework/Physics/InterpolationController.cs)

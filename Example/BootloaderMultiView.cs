...
public partial class BootloaderMultiView : Node
{
	...
	public override void _EnterTree()
	{
		...
		//currently required because of an godot bug in the resource loader
		//required better solution
		GD.Load<CSharpScript>("res://Shared/MyGameLevel.cs");

		this.CreateSlot<MyServerLogic>(false);
		this.CreateSlot<MyClientLogic>();
		//	this.CreateSlot<MyClientLogic>();
	}
	...
	private T CreateSlot<T>(bool isVisible = true) where T : GameLogic
	{
		...
		T viewport = Activator.CreateInstance<T>();
